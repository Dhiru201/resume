...
\name{\textbf{Dhirendra Verma}} {}
\mobile{(+91) 89-482-89628}

\email{dhirendraverma07@gmail.com}
\github{dhiru201}
\linkedin{dhirendra-verma-5b3a32146}
%\skype{skypeid}
...
\position{Software Engineer{\enskip\cdotp\enskip}iOS Expert} % Your expertise/fields
% \quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Dhirendra~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
